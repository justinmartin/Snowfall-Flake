...
in
{
  options.frgd.desktop.gnome = with types; {
    ...
    wallpaper = {
      light = mkOpt (oneOf [ str package ]) pkgs.frgd.wallpapers.nord-rainbow-light-nix "The light wallpaper to use.";
      dark = mkOpt (oneOf [ str package ]) pkgs.frgd.wallpapers.nord-rainbow-dark-nix "The dark wallpaper to use.";
    };
  ...
  config = mkIf cfg.enable {
    ...
    environment.systemPackages = with pkgs; [
      (hiPrio frgd.xdg-open-with-portal)
      wl-clipboard
      gnome.gnome-tweaks
    ...
    systemd.services.frgd-user-icon = {
      ...
      script = ''
        config_file=/var/lib/AccountsService/users/${config.frgd.user.name}
        icon_file=/run/current-system/sw/share/frgd-icons/user/${config.frgd.user.name}/${config.frgd.user.icon.fileName}
        ...
        nested-default-attrs {
          "org/gnome/shell" = {
            ...
            favorite-apps =
              ...
              ++ optional config.frgd.apps.firefox.enable "firefox.desktop"
              ++ optional config.frgd.apps.vscode.enable "code.desktop"
              ++ optional config.frgd.desktop.addons.foot.enable "foot.desktop"
              ++ optional config.frgd.apps.logseq.enable "logseq.desktop"
              ++ optional config.frgd.apps.discord.enable "discord.desktop"
              ++ optional config.frgd.apps.element.enable "element-desktop.desktop"
              ++ optional config.frgd.apps.steam.enable "steam.desktop";
          };
          ...
          "org/gnome/shell/extensions/Logo-menu" = {
            ...
            menu-button-terminal =
              if config.frgd.desktop.addons.term.enable then
                lib.getExe config.frgd.desktop.addons.term.pkg
              else
