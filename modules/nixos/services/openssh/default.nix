...
in
{
  options.frgd.services.openssh = with types; {
    ...
    authorizedKeys =
      mkOpt (listOf str) [ probook-key nixserver-key ] "The public keys to apply.";
