...
with lib.frgd;
let
  cfg = config.frgd.services.vault-agent;
...
in
{
  ...
  options.frgd.services.vault-agent = {
          ...
          (template-name: template:
            {
              ...
              message = "frgd.services.vault-agent.services.${service-name}.secrets.environment.templates.${template-name} must set either `source` or `text`.";
            }
          )
          ...
          (file-name: file:
            {
              ...
              message = "frgd.services.vault-agent.services.${service-name}.secrets.file.files.${file-name} must set either `source` or `text`.";
            }
          )
